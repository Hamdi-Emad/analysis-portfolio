                              ...
                              <div className="data-contact">
                                 <div>
                                    <p className="text-lg text-[#e2e2e2] leading-[1.9]">
                                       If you're interested in what I do, need
                                       help understanding your data, or have a
                                       project you'd like to discuss — I'd love
                                       to hear from you. I enjoy turning raw
                                       data into meaningful insights.
                                       <br />
                                       Feel free to reach out via WhatsApp,
                                       email, or social media — I'll get back to
