               ...
               <div className="flex flex-col justify-center items-center ">
                  <div className="max-w-[800px] w-auto">
                     <p className="text-center md:text-start leading-[2]">
                        ...
                        strong command of the end-to-end data analysis
                        process. I'm skilled in Excel, SQL, Python, Pandas, and
                        NumPy, and I build clear, interactive dashboards using
                        Power BI and Tableau. I'm also confident in data
                        cleaning, wrangling, KPI reporting, and automating tasks
                        using Python. I understand how to turn complex data into
                        actionable insights that support better decision-making.
                        In addition to my data expertise, I have hands-on
                        familiarity with React and Next.js, which helps me
                        collaborate effectively on data-driven web solutions. I
                        hold a Bachelor's degree in English Commerce from
                        Menoufia University, which strengthens my work with a
                        solid foundation in business and financial thinking.
                     </p>
                  </div>
                  <div className="flex flex-col md:flex-row justify-center items-center gap-10 mt-5  w-full">
