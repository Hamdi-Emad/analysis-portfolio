               ...
               <div className="flex flex-col justify-center items-center ">
                  ...
                  <div className="flex flex-col md:flex-row justify-center items-center gap-10 mt-10  w-full">
                     ...
                     <div className="icons flex justify-center items-center gap-5 ">
                        <div className="cursor-pointer bg-[#0a66c2] rounded-full hover:bg-white hover:text-[#0a66c2] transition">
                           <a
                        ...
                        <div className="cursor-pointer bg-[#333333] rounded-full hover:bg-white hover:text-[#333333] transition">
                           <a
